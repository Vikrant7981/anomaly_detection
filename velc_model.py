...
# # Re_Encoder
# #################
# class Re_Encoder(layers.Layer):
#     def __init__(self, time_step, x_dim, lstm_h_dim, z_dim, name='re_encoder', **kwargs):
#         super(Re_Encoder, self).__init__(name=name, **kwargs)
#
#         self.re_encoder_inputs = keras.Input(shape=(time_step, x_dim))
#         self.re_encoder_lstm = Bidirectional(layers.LSTM(lstm_h_dim, activation='softplus', name='re_encoder_lstm', stateful=True))
#         self.re_z_mean = layers.Dense(z_dim, name='re_z_mean')
#         self.re_z_logvar = layers.Dense(z_dim, name='re_z_log_var')
#         self.re_z_sample = Sampling()
#
#     def call(self, inputs):
#         self.re_encoder_inputs = inputs
#         hidden = self.re_encoder_lstm(self.re_encoder_inputs)
#         mu_re_z = self.re_z_mean(hidden)
#         logvar_re_z = self.re_z_logvar(hidden)
#         re_z = self.re_z_sample((mu_re_z, logvar_re_z))
#         return mu_re_z, logvar_re_z, re_z
#
#     def get_config(self):
#         config = super(Re_Encoder, self).get_config()
#         config.update({
#             'name': self.name,
#             're_z_sample': self.re_z_sample.get_config()
#         })
#         return config
